  ...
  return (
    ...
    <div className="py-12 flex flex-col items-center">
        <div className="flex w-full items-center lg:items-center justify-center gap-y-8 mb-8">
            ...
            <h1 className="text-5xl  mr-8 ml-8 text-greytitle font-bold">Preparatory cycle</h1>
            <div className="h-4 w-full lg:w-24  bg-main-blue" />
        </div>
        ...
        <span>Download full preparatory classes program</span>
