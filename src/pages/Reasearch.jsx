...
const ResearchPage = () => {
  ...
  useEffect(() => {
    axios
      .get("https://project-2cs-backend.onrender.com/regulations/category/laboratory")
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get("https://project-2cs-backend.onrender.com/testimonials/partner")
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get("https://project-2cs-backend.onrender.com/articles/research-articles")
      .then((response) => {
